                            ...
                            <div className="materialContainer">
                                <div className="material-details">
                                    <div className="title title1 title-effect mb-1 title-left">
                                        <h2>Contact Us</h2>
                                        <p className="ms-0 w-100">Your email address will not be published. Required
                                            fields are
                                            marked *</p>
                                    </div>
                                </div>
                                <div className="row g-4 mt-md-1 mt-2">
                                    ...
                                    <div className="col-md-6">
                                        <label htmlFor="email2" className="form-label">Confirm Email</label>
                                    ...
                                    <div className="col-12">
                                        ...
                                        <textarea className="form-control" id="comment" rows="5" required=""/>
                                    </div>

                                    <div className="col-auto">
                                        <button className="btn btn-solid-default" type="submit">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
