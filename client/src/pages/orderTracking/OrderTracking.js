                        ...
                        <div className="col-12 overflow-hidden">
                            <div className="order-left-image ratio_asos">
                                <div className="tracking-product-image">
                                    <img src="assets/images/fashion/banner/3.jpg"
                                ...
                                <div className="order-image-contain">
                                    ...
                                    <div className="tracker-number">
                                        <p className="font-light">Order Number : <span>W765EWR8568871</span></p>
                                        <p className="font-light">Brand : <span>Van Heusen</span></p>
                                        <p className="font-light mb-0">Order Placed : <span>June 25, 2021</span></p>
                                    </div>
                                    ...
                                    <h5 className="font-light">Your items is on the way. Tracking information will be
                                        available
                                        within 24 hours.</h5>
                                </div>
                            </div>
