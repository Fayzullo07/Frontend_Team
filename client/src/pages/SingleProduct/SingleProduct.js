...
function SingleProduct(props) {
    ...
    const QuantityFunc = (sign) => {
        if (sign === 'minus' && quantity > 1) {
            setQuantity(quantity - 1)
        } else if (sign === 'plus' && quantity < 9) {
            setQuantity(quantity + 1)
        }
    ...
    return (<>
                                        ...
                                        <div id="selectSize"
                                            ...
                                            <div className="qty-box">
                                                ...
                                                <span className="input-group-prepend">
                                                    <button onClick={() => QuantityFunc('minus')} type="button"
                                                            className="btn quantity-left-minus"
                                                            datatype="minus" datafld="">
                                                        <i className="fas fa-minus"></i>
                                                    </button>
                                                </span>
                                                    <input id={"quantity"} type="text" name="quantity"
                                                           className="form-control input-number" value={quantity}/>
                                                    <span className="input-group-prepend">
                                                    <button onClick={() => QuantityFunc('plus')} type="button"
                                                            className="btn quantity-right-plus"
                                                            datatype="plus" datafld="">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="product-wrapper product-style-2  p-0 light-arrow bottom-space">
                            <Slider {...settings}>
                                <div>
        ...
        <div className="added-notification modal modal-size fade" id="added-notification">
