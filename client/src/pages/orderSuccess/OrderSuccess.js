                        ...
                        <div className="col-12 p-0">
                            <div className="success-icon">
                                ...
                                <div className="success-contain">
                                    <h4>Order Success</h4>
                                    <h5 className="font-light">Payment Is Successfully Processsed And Your Order Is On
                                        The Way</h5>
                                    <h6 className="font-light">Transaction ID:267676GHERT105467</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-md-12">
                                        <div className="delivery-sec">
                                            ...
                                            <Link to={"/order_trackigng"}>track order</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
